...
let users = [
    { id: generateId(), name: "Igor", city: "Kyiv", age: 21 },
    { id: generateId(), name: "Alex", city: "Lviv", age: 52 },
    { id: generateId(), name: "Oleg", city: "Sevastopol", age: 15 },
    { id: generateId(), name: "Ivan", city: "Vinica", age: 27 },
    { id: generateId(), name: "Stepan", city: "Bucha", age: 54 },
    { id: generateId(), name: "Bogdan", city: "Kupansk", age: 16 },
    { id: generateId(), name: "Mihailo", city: "Brovari", age: 28 },
    { id: generateId(), name: "Alexandr", city: "Chernigiv", age: 55 },
    { id: generateId(), name: "Petro", city: "Odessa", age: 18 },
    { id: generateId(), name: "Volodimir", city: "Ternipil`", age: 19 },
    { id: generateId(), name: "Igor", city: "jitomir", age: 23 },
];
